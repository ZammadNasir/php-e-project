<?php
include('./front-end/includes/config.php');
session_start();
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0 table-responsive">
                            ...
                            <tbody>
                                <?php
                                $select_msg = mysqli_query($connection, "SELECT *, COUNT(Name) AS numbers FROM orders GROUP BY Name ORDER BY numbers DESC LIMIT 10");
